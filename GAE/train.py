...
def load_test_names():
    return load_json(setting.DataPath, 'test_name_list.json')

# average until now [0.7541151961940835, 0.5583717347819256, 0.6416469381697782]
def main():
    names = load_test_names()
    wf = codecs.open(join(setting.out, 'local_clustering_results.csv'), 'w', encoding='utf-8')
...
if __name__ == '__main__':
    # precision 0.66682 recall 0.40096 f1 0.50080
    # gae_for_na('shanxuan_test')
    # pairwise precision 0.60079 recall 0.64723 f1 0.62315
    gae_for_na('Hongbin Li')
    # print('shanxuan_test')
