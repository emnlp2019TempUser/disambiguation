...
local_na_dir = setting.materialData
...
def load_local_data(path=local_na_dir, name='cheng_cheng'):
    ...
    print('edges_unordered: ', edges_unordered, ',after flatten:', edges_unordered.flatten(), ', edges_unordered :', edges_unordered.shape)
    # print('idx_map: ', idx_map, ', idx_map.get: ', idx_map.get, map(idx_map.get, edges_unordered.flatten()))
    ...
    return adj, features, labels, idx_features_labels[:, 0]
